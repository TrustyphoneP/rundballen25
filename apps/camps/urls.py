...
urlpatterns = [
    ...
    path("freizeit/<int:camp_pk>/skf-briefing/",       views.skf_briefing_days,  name="skf_briefing_days"),
    path("freizeit/<int:camp_pk>/skf-briefing/<int:day_pk>/", views.skf_briefing_day, name="skf_briefing_day"),
