    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("intolerance_notes", models.TextField(blank=True, verbose_name="Zusatzhinweise Unvertraeglichkeiten")),
                ("created_at",        models.DateTimeField(auto_now_add=True)),
                ...
                ("intolerances", models.ManyToManyField(blank=True, related_name="participants", to="recipes.allergen", verbose_name="Allergien / Unvertraeglichkeiten")),
            ],
