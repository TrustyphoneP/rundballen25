...
urlpatterns = [
    ...
    path("<int:pk>/gericht/hinzufügen/",              views.admin_add_recipe,    name="add_recipe"),
    path("<int:pk>/gericht/<int:recipe_pk>/toggle/",   views.admin_toggle_recipe, name="toggle_recipe"),
    path("<int:pk>/gericht/<int:recipe_pk>/löschen/", views.admin_delete_recipe, name="delete_recipe"),
